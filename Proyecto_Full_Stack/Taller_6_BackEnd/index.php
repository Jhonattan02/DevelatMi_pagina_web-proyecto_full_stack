...
<body>
    <header>
        <img class="illus" src="recursos/Component 2.png" alt="figure">
        <div class="header-contain">
            <div class="title">
                <h2>BackEnd Basado en proyectos.</h2>
                <h1>solucion taller backend - unidad 6</h1>
                <p>Evaluar los conocimientos de PHP, sentencias, variables, formularios, envíos de datos, métodos POST y GET, entre otros.
                </p>
                <a href="">Ver Solución</a>
            </div>
    ...
    <section id="section-description">
        <div class="illustration">
            <img src="recursos/servcios-it-desarrollo-software 2.png"
        </div>
        <div class="descript">
            ...
            <p>Según lo visto en el módulo de Backend basado en proyectos, conteste las siguientes preguntas
                ...
                formularios, envío de datos, métodos POST y GET, entre otros.
            </p>
        </div>
    </section>
